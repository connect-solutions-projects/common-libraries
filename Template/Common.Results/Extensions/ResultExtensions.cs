...
namespace $safeprojectname$.Common.Results.Extensions
{
    /// <summary>
    ...
    public static class ResultExtensions
    {
        ...
        /// </summary>
        /// <param name="result">O resultado a ser modificado.</param>
        /// <param name="error">A mensagem de erro a ser adicionada.</param>
        /// <returns>O resultado modificado para permitir encadeamento de chamadas.</returns>
        /// <exception cref="ArgumentNullException">Lançada quando result é null.</exception>
        ...
        /// <summary>
        /// Adiciona um erro com código ao resultado.
        /// </summary>
        /// <param name="result">O resultado a ser modificado.</param>
        ...
        /// <summary>
        /// Adiciona múltiplos erros ao resultado.
        /// </summary>
        /// <param name="result">O resultado a ser modificado.</param>
        /// <param name="errors">A coleção de erros a ser adicionada.</param>
        /// <returns>O resultado modificado para permitir encadeamento de chamadas.</returns>
        /// <exception cref="ArgumentNullException">Lançada quando result é null.</exception>
        ...
        /// <summary>
        /// Define a exceção associada ao resultado.
        /// </summary>
        /// <param name="result">O resultado a ser modificado.</param>
        ...
        /// <summary>
        /// Marca o resultado como encontrado (Found = true).
        /// </summary>
        /// <param name="result">O resultado a ser modificado.</param>
        /// <returns>O resultado modificado para permitir encadeamento de chamadas.</returns>
        /// <exception cref="ArgumentNullException">Lançada quando result é null.</exception>
        ...
        /// <summary>
        /// Marca o resultado como não encontrado (Found = false).
        /// </summary>
        /// <param name="result">O resultado a ser modificado.</param>
        /// <returns>O resultado modificado para permitir encadeamento de chamadas.</returns>
        /// <exception cref="ArgumentNullException">Lançada quando result é null.</exception>
        ...
        {
            ArgumentNullException.ThrowIfNull(result);
            return result.Failed(errorMessage).WithException(ex).WithData(default(T)!);
        }
        #endregion
        ...
        public static string GetMessageOrError(this IResult result)
        {
            ...
            {
                var text = string.Join(" | ", errors.Where(e => e != null).Select(x => x.Error ?? string.Empty));
        ...
        /// <summary>
        /// Obtém o resultado serializado como JSON com filtro de metadados.
        /// </summary>
        /// <param name="result">O resultado a ser serializado.</param>
        /// <param name="includeException">Indica se deve incluir exceções na serialização.</param>
        /// <param name="metadataKeysToInclude">Lista de chaves de metadados a incluir. Se null, inclui todos.</param>
        /// <returns>JSON string do resultado.</returns>
        /// <exception cref="ArgumentNullException">Lançada quando result é null.</exception>
        public static string GetMessageOrErrorToJson(this IResult result, bool includeException, IEnumerable<string> metadataKeysToInclude)
        {
            ArgumentNullException.ThrowIfNull(result);
            ...
            if (result.Errors != null)
            {
                errorsList = result.Errors
                    ...
                    .Select(e => e.Error)
                    .ToList();
                if (errorsList.Count == 0) errorsList = null;
            }
            ...
            if (r != null)
            {
                ...
                else if (r.Metadata != null)
                {
                    ...
                    foreach (var key in metadataKeysToInclude)
                    {
                        ...
                        object val;
                        if (r.Metadata.TryGetValue(key, out val))
                            metadata[key] = val;
                    }
                    if (metadata.Count == 0) metadata = null;
                }
            }

            // Exceção (somente se solicitado)
            object exceptionDto = null;
            if (includeException && r != null && r.Exception != null)
            {
                var ex = r.Exception;
                exceptionDto = new
                {
            ...
            return JsonSerializer.Serialize(
                 ...
                 new JsonSerializerOptions
                 {
                     ...
                     WriteIndented = false // equivalente ao Formatting.None
                 }
             );
        }
        #endregion
